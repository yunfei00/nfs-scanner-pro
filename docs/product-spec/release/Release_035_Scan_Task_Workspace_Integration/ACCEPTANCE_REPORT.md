...
- [PASS] `runtime_isolation` (0.09s) — runtime/verification/R035/workspace_state_mock.json
- [PASS] `mainwindow_boot` (0.84s)
- [PASS] `current_project_init` (0.47s) — iPhone16_Mainboard
- [PASS] `project_switch_scan_sync` (0.86s)
- [PASS] `project_a_scan_result_path` (5.79s) — runtime/verification/R035/mock_projects/iPhone16_Mainboard/scans/ST-1A444E
- [PASS] `project_b_scan_result_path` (6.85s) — runtime/verification/R035/mock_projects/RF_Module_Test/scans/ST-F5E03D
...
- [PASS] `page_switch_regression` (2.12s)
...
- `runtime/verification/R035/mock_projects/iPhone16_Mainboard/scans/ST-1A444E`

## 项目 B 扫描结果路径

- `runtime/verification/R035/mock_projects/RF_Module_Test/scans/ST-F5E03D`
