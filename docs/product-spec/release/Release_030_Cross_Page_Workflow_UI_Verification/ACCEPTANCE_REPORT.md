...
- [PASS] `scan_ui_workflow` — task=ST-810A08 fallback=False points=6461/6461
- [PASS] `scan_result_files` — dir=D:\code_2026\nfs-scanner-pro\runtime\mock_projects\iPhone16_Mainboard\scans\ST-810A08 csv_rows=200
- [PASS] `analysis_loads_scan_task` — task=ST-810A08 points=6461
- [PASS] `analysis_mock_interactions` — trace=Trace 2 freq=2.450 GHz
- [PASS] `report_creates_draft` — draft=D:\code_2026\nfs-scanner-pro\runtime\mock_projects\iPhone16_Mainboard\reports\RP-754BB4BF\report_draft.json name='CPU_Area_Hx_2.45GHz_报告'
...
- `runtime/mock_projects/iPhone16_Mainboard/scans/ST-810A08/`

## runtime 报告草稿

- `runtime/mock_projects/iPhone16_Mainboard/reports/RP-754BB4BF/report_draft.json`
