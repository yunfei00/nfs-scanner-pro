...
- [PASS] `compileall`
- [PASS] `mock_scan_result_ready` — D:\code_2026\nfs-scanner-pro\runtime\mock_projects\iPhone16_Mainboard\scans\ST-VERIFY-027
...
- [PASS] `analysis_data_source` — tasks=38 status='状态：分析就绪，已加载 Mock 扫描结果 ST-VERIFY-027'
...
- `runtime/mock_projects/iPhone16_Mainboard/scans/ST-VERIFY-027/`
