...
- [PASS] `check_real_devices_safe_default` (0.53s)
- [PASS] `mock_ui_unchanged` (3.81s)
- [PASS] `top_menu_always_visible` (0.34s) — menus=['文件(F)', '编辑(E)', '视图(V)', '工具(T)', '设置(S)', '帮助(H)']
