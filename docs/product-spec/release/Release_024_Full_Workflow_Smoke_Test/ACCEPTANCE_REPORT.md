...
- [PASS] `device_mock`
- [PASS] `scan_engine` — task=ST-5DC26E points=6461/6461
- [PASS] `scan_result_persistence` — dir=ST-5DC26E csv_rows=200 msg=True
- [PASS] `analysis_page` — dock='分析参数' task=ST-5DC26E trace=Trace 1
...
- `runtime/mock_projects/iPhone16_Mainboard/scans/ST-5DC26E/`
