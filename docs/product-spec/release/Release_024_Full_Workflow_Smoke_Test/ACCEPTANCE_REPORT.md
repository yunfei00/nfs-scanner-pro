...
- [PASS] `device_mock`
- [PASS] `scan_engine` — task=ST-6C8107 points=6461/6461
- [PASS] `scan_result_persistence` — dir=ST-6C8107 csv_rows=200 msg=True
- [PASS] `analysis_page` — dock='分析参数' task=ST-6C8107 trace=Trace 1
...
- `runtime/mock_projects/iPhone16_Mainboard/scans/ST-6C8107/`
- `runtime/mock_projects/iPhone16_Mainboard/reports/RP-SMOKE-024/report_draft.json`
