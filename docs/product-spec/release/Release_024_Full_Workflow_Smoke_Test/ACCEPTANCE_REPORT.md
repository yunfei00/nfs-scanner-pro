...
- [PASS] `device_mock`
- [PASS] `scan_engine` — task=ST-C5213F points=6461/6461
- [PASS] `scan_result_persistence` — dir=ST-C5213F csv_rows=200 msg=True
- [PASS] `analysis_page` — dock='分析参数' task=ST-C5213F trace=Trace 1
...
- `runtime/verification/R024/mock_projects/iPhone16_Mainboard/scans/ST-C5213F/`
