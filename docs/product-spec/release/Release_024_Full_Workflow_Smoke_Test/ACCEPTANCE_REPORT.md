...
- [PASS] `device_mock`
- [PASS] `scan_engine` — task=ST-C3B7ED points=6461/6461
- [PASS] `scan_result_persistence` — dir=ST-C3B7ED csv_rows=200 msg=True
- [PASS] `analysis_page` — dock='分析参数' task=ST-C3B7ED trace=Trace 1
...
- `runtime/verification/R024/mock_projects/iPhone16_Mainboard/scans/ST-C3B7ED/`
