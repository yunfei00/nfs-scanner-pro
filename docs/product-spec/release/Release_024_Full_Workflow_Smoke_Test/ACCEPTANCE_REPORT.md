...
- [PASS] `device_mock`
- [PASS] `scan_engine` — task=ST-3A0C97 points=6461/6461
- [PASS] `scan_result_persistence` — dir=ST-3A0C97 csv_rows=200 msg=True
- [PASS] `analysis_page` — dock='分析参数' task=ST-3A0C97 trace=Trace 1
...
- `runtime/verification/R024/mock_projects/iPhone16_Mainboard/scans/ST-3A0C97/`
