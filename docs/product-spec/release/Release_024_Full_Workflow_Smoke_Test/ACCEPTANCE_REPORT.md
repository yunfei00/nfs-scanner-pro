...
- [PASS] `device_mock`
- [PASS] `scan_engine` — task=ST-CECCD6 points=6461/6461
- [PASS] `scan_result_persistence` — dir=ST-CECCD6 csv_rows=200 msg=True
- [PASS] `analysis_page` — dock='分析参数' task=ST-CECCD6 trace=Trace 1
...
- `runtime/mock_projects/iPhone16_Mainboard/scans/ST-CECCD6/`
