...
- [PASS] `scaffold_dry_run` (0.11s)
- [PASS] `scaffold_temp_generate` (0.51s)
- [PASS] `scaffold_existing_release_guard` (0.09s)
- [PASS] `scaffold_template_content` (0.00s)
- [PASS] `verify_all_cli` (59.87s)
