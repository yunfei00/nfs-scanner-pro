...
- [PASS] `compileall` (0.72s)
- [PASS] `real_scan_plan_imports` (0.00s)
- [PASS] `generate_3x3_plan` (0.00s)
- [PASS] `soft_limit_validation` (0.00s)
- [PASS] `scan_plan_persistence` (0.04s) — runtime/verification/R042/scan_plans/SP3x3-770B7DAE/scan_plan.json
- [PASS] `dry_run_script_no_save` (1.80s)
- [PASS] `dry_run_script_save` (0.73s)
- [PASS] `no_real_connection_or_sampling` (0.73s)
- [PASS] `source_no_motion_or_sweep_commands` (0.00s)
- [PASS] `mock_ui_unchanged` (31.73s)
