...
- [PASS] `app_paths_runtime_override` (0.00s) — runtime\verification\R032
- [PASS] `verify_all_isolated_only` (9.89s)
- [PASS] `verify_all_isolated_from` (7.77s)
- [PASS] `runtime_no_mock_projects_pollution` (0.06s) — new_st_verify=0 isolated_json=True
- [PASS] `legacy_scripts_no_hardcoded_runtime` (0.01s) — checked 9 scripts
- [PASS] `verify_all_cli` (12.03s)
