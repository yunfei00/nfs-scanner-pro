...
- [PASS] `manual_session_persistence` (0.04s) — runtime/verification/R043/manual_scan_sessions/MS-08741D90/manual_scan_session.json
- [PASS] `script_default_safe` (0.73s)
- [PASS] `script_create_session` (1.17s)
- [PASS] `script_fake_sample` (0.80s)
- [PASS] `script_requires_confirm_for_real_sample` (0.73s)
- [PASS] `source_no_motion_or_sweep_commands` (0.00s)
- [PASS] `mock_ui_unchanged` (31.29s)
