...
VERIFY_SCRIPTS: tuple[tuple[int, str, Path], ...] = (
    ...
    (33, "Release 033", SCRIPTS / "verify_release_033.py"),
    ...
    (39, "Release 039", SCRIPTS / "verify_release_039.py"),
    (40, "Release 040", SCRIPTS / "verify_release_040.py"),
    (41, "Release 041", SCRIPTS / "verify_release_041.py"),
    (42, "Release 042", SCRIPTS / "verify_release_042.py"),
    (43, "Release 043", SCRIPTS / "verify_release_043.py"),
    (44, "Release 044", SCRIPTS / "verify_release_044.py"),
    (45, "Release 045", SCRIPTS / "verify_release_045.py"),
    (46, "Release 046", SCRIPTS / "verify_release_046.py"),
    (47, "Release 047", SCRIPTS / "verify_release_047.py"),
    (48, "Release 048", SCRIPTS / "verify_release_048.py"),
)
